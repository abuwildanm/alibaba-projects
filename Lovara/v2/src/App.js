...
import Events from './pages/Events';  // New flow
import VideoChat from './pages/VideoChat';  // New flow
  ...
  return (
    <div className="app-container">
      ...
      <Routes>
        ...
        <Route path="/events" element={currentUser ? <Events /> : <Navigate to="/login" />} /> {/* New flow */}
        <Route path="/video-chat" element={currentUser ? <VideoChat /> : <Navigate to="/login" />} /> {/* New flow */}
      </Routes>
    </div>
  );
}
