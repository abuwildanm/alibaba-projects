      ...
      <Row>
        <Col md={12}>
          <Card className="shadow-sm border-0" style={{ borderRadius: '16px' }}>
            <Card.Header className="d-flex justify-content-between align-items-center py-3" style={{ 
              ...
              {!editMode && (
                <Button variant="light" className="fw-bold" onClick={() => setEditMode(true)}>
                  ...
                  <Row>
                    <Col md={4} className="text-center">
                      <img
                        ...
                        alt="Profile"
                        className="profile-image-large img-fluid rounded-circle mb-3 border border-3 border-light shadow"
                        style={{ width: '180px', height: '180px', objectFit: 'cover' }}
                      />
                      <h5 className="text-gradient">{userData.name}</h5>
                      ...
                      {editMode ? (
                        <Form>
                          ...
                          <div className="d-flex gap-2">
                            <Button variant="success" onClick={handleSave} className="flex-fill">
                              Save Changes
                            </Button>
                        ...
                        <div>
                          ...
                          <h6 className="text-gradient">Interests</h6>
                          ...
                          <h6 className="text-gradient">Additional Information</h6>
                  ...
                  <Row>
                    {(userData.photos || []).map((photo, index) => (
                      <Col key={index} xs={6} md={3} className="mb-3">
                        <img
                          ...
                          style={{ objectFit: 'cover', aspectRatio: '3/4', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}
                        />
                        {editMode && (
                          <Button
                    ...
                    {editMode && (
                      <Col xs={6} md={3} className="mb-3 d-flex align-items-center justify-content-center">
                        <Button variant="outline-secondary" className="d-flex flex-column align-items-center p-3">
